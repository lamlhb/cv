...
\documentclass[13pt, a4paper]{russell}
...
\name{Lam.}{Le Hoang Bao}
\position{Software Developer}
\address{Ha Dong Dist, Hanoi}

\mobile{0988160296}
\email{lamlh.hust@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
%\github{github.com/lamlhb}
\linkedin{linkedin.com/in/lamlhb/}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
% \skype{live:.cid.f40bd226b5ce56a0}
% \reddit{reddit-id}
% \medium{madium-id}
% \kaggle{kaggle-id}
